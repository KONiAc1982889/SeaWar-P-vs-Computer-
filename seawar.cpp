...
void Avake()
{
	...
	SetCursor(24, 12);
	cout << "Sea War(Player vs Computer)";
}
...
void Meny(int num)
{
	char variant[11][40] = { "Enemy's turn...","Enemy's miss!", "Hit!", "Enemy's win...maybe next time...", "Your turn." , "Miss...", "Nice shot!", "Nice win, General!", "+++++++++++++++++++++++++++++++++++++++", "Nice shot,another one!", "You destroied enemy's ship!" };
...
int main()
{
	...
	srand(time(NULL));
	char variant[2][30] = { "Auto arrange","Manual arrange" };
